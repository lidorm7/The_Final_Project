...
-- Design Ports Information
-- BiPhase_tx_out	=>  Location: PIN_AB7,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 8mA
...
ARCHITECTURE structure OF Card_A_Design IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
SIGNAL \tx|transmission:sig_cntr[3]~2_combout\ : std_logic;
...
SIGNAL \tx|transmission:sig_cntr[3]~0_combout\ : std_logic;
SIGNAL \tx|transmission:sig_cntr[3]~1_combout\ : std_logic;
...
SIGNAL \rx|Selector13~1_combout\ : std_logic;
SIGNAL \rx|state_rx.s2~q\ : std_logic;
SIGNAL \rx|sig_ram_address[5]~0_combout\ : std_logic;
SIGNAL \rx|Selector14~0_combout\ : std_logic;
...
SIGNAL \biphase|sig_read_address[2]~feeder_combout\ : std_logic;
...
-- Equation(s):
-- \rx|Equal0~0_combout\ = (!\rx|Add0~2_combout\ & (!\rx|Add0~0_combout\ & (!\rx|Add0~6_combout\ & \rx|Add0~4_combout\)))
...
PORT MAP (
	...
	datab => \rx|Add0~8_combout\,
	datac => \rx|Add0~10_combout\,
	datad => \rx|Add0~12_combout\,
...
-- Equation(s):
-- \rx|Equal0~1_combout\ = (\rx|Equal0~0_combout\ & (\rx|Add0~8_combout\ & (!\rx|Add0~10_combout\ & !\rx|Add0~12_combout\)))
...
-- Equation(s):
-- \rx|Selector3~0_combout\ = (\rx|state_rx.s3~q\ & (\rx|main_rx:var_bit_cntr[1]~q\ $ (((\rx|main_rx:var_bit_cntr[0]~q\ & \rx|Equal3~0_combout\)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \rx|main_rx:var_bit_cntr[0]~q\,
...
-- Equation(s):
-- \biphase|sig_inc~0_combout\ = (\resetn~input_o\ & (!\biphase|sig_cut_not~q\ & \biphase|sig_cut~q\))
...
PORT MAP (
	...
	datab => \biphase|sig_inc~0_combout\,
...
-- Equation(s):
-- \biphase|Selector2~0_combout\ = (!\biphase|state_mini.s5a~q\ & ((\biphase|state_mini.s0a~q\) # (\biphase|sig_inc~q\)))
...
-- pragma translate_on
PORT MAP (
	datab => \biphase|state_mini.s5a~q\,
	datac => \biphase|state_mini.s0a~q\,
	datad => \biphase|sig_inc~q\,
...
-- pragma translate_on
PORT MAP (
	datab => \biphase|state_mini.s0a~q\,
...
-- Equation(s):
-- \biphase|Selector4~0_combout\ = (\biphase|state_mini.s1a~q\ & !\biphase|sig_inc~q\)
...
-- pragma translate_on
PORT MAP (
	dataa => \biphase|state_mini.s3a~q\,
...
-- Equation(s):
-- \biphase|sig_read_address_cnt[1]~5_combout\ = (\biphase|sig_read_address_cnt\(0) & (\biphase|sig_read_address_cnt\(1) $ (VCC))) # (!\biphase|sig_read_address_cnt\(0) & (\biphase|sig_read_address_cnt\(1) & VCC))
-- \biphase|sig_read_address_cnt[1]~6\ = CARRY((\biphase|sig_read_address_cnt\(0) & \biphase|sig_read_address_cnt\(1)))
...
-- pragma translate_on
PORT MAP (
	dataa => \biphase|sig_read_address_cnt\(0),
...
-- pragma translate_on
PORT MAP (
	datab => \biphase|sig_read_address_cnt\(3),
	datad => VCC,
...
-- Equation(s):
-- \biphase|start_strobe_tx~0_combout\ = (\biphase|state_mini.s2a~q\ & (!\biphase|sig_read_address_cnt\(4) & (\resetn~input_o\ & !\biphase|sig_read_address_cnt\(3))))
...
-- pragma translate_on
PORT MAP (
	dataa => \biphase|state_mini.s2a~q\,
...
-- Equation(s):
-- \biphase|start_strobe_tx~1_combout\ = (\biphase|sig_read_address_cnt\(0) & (\biphase|start_strobe_tx~0_combout\ & (\biphase|sig_read_address_cnt\(1) & \biphase|sig_read_address_cnt\(2))))
...
PORT MAP (
	dataa => \biphase|sig_read_address_cnt\(0),
	datab => \biphase|start_strobe_tx~0_combout\,
	datac => \biphase|sig_read_address_cnt\(1),
...
-- Equation(s):
-- \biphase|start_strobe_tx~2_combout\ = (\biphase|start_strobe_tx~1_combout\) # ((\biphase|start_strobe_tx~q\ & ((!\resetn~input_o\) # (!\biphase|state_mini.s2a~q\))))
...
PORT MAP (
	...
	datad => \biphase|start_strobe_tx~1_combout\,
...
-- Equation(s):
-- \tx|Selector12~0_combout\ = (!\tx|transmission:sig_cntr[3]~1_combout\ & (\tx|transmission:sig_cntr[0]~q\ $ (\tx|transmission:sig_cntr[1]~q\)))
...
PORT MAP (
	...
	datad => \tx|transmission:sig_cntr[3]~1_combout\,
	combout => \tx|Selector12~0_combout\);

-- Location: LCCOMB_X46_Y9_N24
\tx|Selector11~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \tx|Selector11~0_combout\ = (!\tx|transmission:sig_cntr[3]~1_combout\ & (\tx|transmission:sig_cntr[2]~q\ $ (((\tx|transmission:sig_cntr[0]~q\ & \tx|transmission:sig_cntr[1]~q\)))))
...
PORT MAP (
	...
	clrn => \resetn~input_o\,
	ena => \tx|transmission:sig_cntr[3]~2_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \tx|Selector3~0_combout\ = (\tx|transmission:sig_cntr[0]~q\ & (!\tx|transmission:sig_cntr[3]~q\ & (!\tx|transmission:sig_cntr[1]~q\ & !\tx|transmission:sig_cntr[2]~q\)))
...
PORT MAP (
	...
	datac => \tx|transmission:sig_cntr[1]~q\,
	datad => \tx|transmission:sig_cntr[2]~q\,
...
-- Equation(s):
-- \tx|Selector6~0_combout\ = (\tx|state_tx.s5~q\) # ((!\tx|Equal2~0_combout\ & \tx|state_tx.s6~q\))
...
-- Equation(s):
-- \tx|Equal0~0_combout\ = (\tx|Add0~6_combout\ & (!\tx|Add0~4_combout\ & (\tx|Add0~2_combout\ & \tx|Add0~0_combout\)))
...
-- Equation(s):
-- \tx|cnt_baud~4_combout\ = (\tx|Add0~14_combout\ & ((\tx|cnt_baud~1_combout\) # ((!\tx|Add0~18_combout\) # (!\tx|Equal0~1_combout\))))
...
-- Equation(s):
-- \tx|cnt_baud~2_combout\ = (\tx|Add0~2_combout\ & ((\tx|cnt_baud~1_combout\) # ((!\tx|Add0~18_combout\) # (!\tx|Equal0~1_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \tx|baud_clock:cnt_baud[3]~q\,
	datad => VCC,
	cin => \tx|Add0~5\,
...
-- Equation(s):
-- \tx|cnt_baud~3_combout\ = (\tx|Add0~6_combout\ & (((\tx|cnt_baud~1_combout\) # (!\tx|Add0~18_combout\)) # (!\tx|Equal0~1_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \tx|baud_clock:cnt_baud[5]~q\,
	datad => VCC,
	cin => \tx|Add0~9\,
...
-- Equation(s):
-- \tx|Equal0~1_combout\ = (!\tx|Add0~12_combout\ & (\tx|Add0~14_combout\ & (!\tx|Add0~8_combout\ & !\tx|Add0~10_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \tx|Add0~12_combout\,
	datab => \tx|Add0~14_combout\,
	datac => \tx|Add0~8_combout\,
...
-- Equation(s):
-- \tx|Equal0~2_combout\ = (\tx|Equal0~1_combout\ & (\tx|Equal0~0_combout\ & (\tx|Add0~18_combout\ & !\tx|Add0~16_combout\)))
...
-- Equation(s):
-- \tx|sig_arising_edge~combout\ = (!\tx|signal_A_q_not~q\ & \tx|signal_A_q~q\)
...
PORT MAP (
	...
	datad => \tx|signal_A_q~q\,
	combout => \tx|sig_arising_edge~combout\);

-- Location: LCCOMB_X46_Y9_N8
\tx|transmission:sig_cntr[3]~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \tx|transmission:sig_cntr[3]~2_combout\ = (\tx|state_tx.s9~q\ & (((\tx|sig_arising_edge~combout\)))) # (!\tx|state_tx.s9~q\ & ((\tx|state_tx.s6~q\) # ((\tx|state_tx.s2~q\))))
...
PORT MAP (
	...
	combout => \tx|transmission:sig_cntr[3]~2_combout\);
...
-- Equation(s):
-- \tx|Selector10~0_combout\ = (\tx|Add1~0_combout\ & !\tx|transmission:sig_cntr[3]~1_combout\)
...
-- Equation(s):
-- \tx|Equal3~0_combout\ = (\tx|transmission:sig_cntr[0]~q\ & (\tx|transmission:sig_cntr[3]~q\ & (\tx|transmission:sig_cntr[1]~q\ & !\tx|transmission:sig_cntr[2]~q\)))
...
-- Equation(s):
-- \tx|state_tx~28_combout\ = (\tx|Equal3~0_combout\ & (\tx|signal_A_q~q\ & (\tx|state_tx.s9~q\ & !\tx|signal_A_q_not~q\)))
...
PORT MAP (
	...
	datad => \tx|signal_A_q_not~q\,
	combout => \tx|state_tx~28_combout\);

-- Location: FF_X47_Y11_N9
...
-- Equation(s):
-- \tx|sig_address[1]~5_combout\ = (\tx|sig_address\(0) & (\tx|sig_address\(1) $ (VCC))) # (!\tx|sig_address\(0) & (\tx|sig_address\(1) & VCC))
-- \tx|sig_address[1]~6\ = CARRY((\tx|sig_address\(0) & \tx|sig_address\(1)))
...
-- Equation(s):
-- \tx|Selector0~0_combout\ = (\tx|state_tx.s10~q\ & (!\tx|Equal4~1_combout\ & ((\biphase|start_strobe_tx~q\) # (\tx|state_tx.s0~q\)))) # (!\tx|state_tx.s10~q\ & ((\biphase|start_strobe_tx~q\) # ((\tx|state_tx.s0~q\))))
...
-- Equation(s):
-- \tx|Selector2~0_combout\ = (\tx|state_tx.s1~q\ & (((!\tx|Equal4~1_combout\ & \tx|state_tx.s10~q\)) # (!\biphase|start_strobe_tx~q\))) # (!\tx|state_tx.s1~q\ & (!\tx|Equal4~1_combout\ & ((\tx|state_tx.s10~q\))))
...
\tx|transmission:sig_cntr[3]~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \tx|transmission:sig_cntr[3]~0_combout\ = (\tx|state_tx.s2~q\ & (\tx|Selector3~0_combout\)) # (!\tx|state_tx.s2~q\ & (((\tx|Equal3~0_combout\ & \tx|state_tx.s9~q\))))
...
PORT MAP (
	...
	datad => \tx|state_tx.s9~q\,
	combout => \tx|transmission:sig_cntr[3]~0_combout\);

-- Location: LCCOMB_X46_Y9_N6
\tx|transmission:sig_cntr[3]~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \tx|transmission:sig_cntr[3]~1_combout\ = (\tx|transmission:sig_cntr[3]~0_combout\) # ((!\tx|state_tx.s2~q\ & (\tx|Equal2~0_combout\ & !\tx|state_tx.s9~q\)))
...
PORT MAP (
	dataa => \tx|state_tx.s2~q\,
	datab => \tx|transmission:sig_cntr[3]~0_combout\,
	datac => \tx|Equal2~0_combout\,
	datad => \tx|state_tx.s9~q\,
	combout => \tx|transmission:sig_cntr[3]~1_combout\);

-- Location: LCCOMB_X46_Y9_N26
\tx|Selector13~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \tx|Selector13~0_combout\ = (!\tx|transmission:sig_cntr[0]~q\ & !\tx|transmission:sig_cntr[3]~1_combout\)
...
-- Equation(s):
-- \tx|Equal2~0_combout\ = (!\tx|transmission:sig_cntr[0]~q\ & (!\tx|transmission:sig_cntr[3]~q\ & (!\tx|transmission:sig_cntr[1]~q\ & \tx|transmission:sig_cntr[2]~q\)))
...
-- Equation(s):
-- \tx|Selector17~0_combout\ = (\tx|state_tx.s9~q\) # (\tx|sig_byte\(7))
...
-- pragma translate_on
PORT MAP (
	datac => \tx|dut|altsyncram_component|auto_generated|q_a\(6),
...
-- pragma translate_on
PORT MAP (
	datac => \tx|dut|altsyncram_component|auto_generated|q_a\(5),
...
-- Equation(s):
-- \tx|Selector25~0_combout\ = (!\tx|state_tx.s7~q\ & \tx|sig_packet\(0))
...
-- Equation(s):
-- \tx|sig_bit~0_combout\ = (\tx|state_tx.s9~q\ & ((\tx|sig_arising_edge~combout\ & ((!\tx|sig_packet\(0)))) # (!\tx|sig_arising_edge~combout\ & (\tx|sig_bit~q\)))) # (!\tx|state_tx.s9~q\ & (((\tx|sig_bit~q\))))
...
-- Equation(s):
-- \rx|sig_data_bit~0_combout\ = (\resetn~input_o\ & (\rx|Equal3~0_combout\ & \rx|main_rx:var_clk_cntr[5]~0_combout\))
...
PORT MAP (
	...
	datab => \rx|Equal3~0_combout\,
	datad => \rx|main_rx:var_clk_cntr[5]~0_combout\,
...
PORT MAP (
	...
	datab => \rx|state_rx.s2~q\,
	datac => \rx|Selector11~0_combout\,
	datad => \rx|state_rx.s5~q\,
...
-- Equation(s):
-- \rx|Add3~1_combout\ = \rx|main_rx:var_bit_cntr[3]~q\ $ (((\rx|main_rx:var_bit_cntr[0]~q\ & (\rx|main_rx:var_bit_cntr[1]~q\ & \rx|main_rx:var_bit_cntr[2]~q\))))
...
PORT MAP (
	dataa => \rx|main_rx:var_bit_cntr[0]~q\,
	datab => \rx|main_rx:var_bit_cntr[1]~q\,
	datac => \rx|main_rx:var_bit_cntr[2]~q\,
...
-- Equation(s):
-- \rx|state_rx~17_combout\ = (\rx|main_rx:var_bit_cntr[2]~q\ & (\rx|Equal3~0_combout\ & (\rx|Add3~0_combout\ & !\rx|main_rx:var_bit_cntr[3]~q\))) # (!\rx|main_rx:var_bit_cntr[2]~q\ & (\rx|main_rx:var_bit_cntr[3]~q\ & ((!\rx|Add3~0_combout\) # 
-- (!\rx|Equal3~0_combout\))))
...
-- Equation(s):
-- \rx|Selector12~1_combout\ = (\rx|state_rx.s4~q\) # ((\rx|state_rx~18_combout\ & (\rx|state_rx~17_combout\ & \rx|state_rx.s3~q\)))
...
-- Equation(s):
-- \rx|state_rx~16_combout\ = (\rx|Equal2~1_combout\ & (!\rx|signal_A_q_not~q\ & \rx|signal_A_q~q\))
...
PORT MAP (
	...
	datad => \rx|signal_A_q~q\,
	combout => \rx|state_rx~16_combout\);

-- Location: LCCOMB_X49_Y27_N4
\rx|Selector12~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \rx|Selector12~0_combout\ = (\rx|state_rx.s1~q\ & (\rx|state_rx~16_combout\)) # (!\rx|state_rx.s1~q\ & (((\rx|sig_bouncer_bit~q\) # (\rx|state_rx.s0~q\))))
...
-- Equation(s):
-- \rx|Selector12~2_combout\ = (!\rx|Selector12~1_combout\ & (!\rx|state_rx.s2~q\ & (!\rx|Selector12~0_combout\ & !\rx|state_rx.s5~q\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \rx|Selector12~1_combout\,
	datab => \rx|state_rx.s2~q\,
	datac => \rx|Selector12~0_combout\,
	datad => \rx|state_rx.s5~q\,
...
-- Equation(s):
-- \rx|Selector13~0_combout\ = (\rx|Equal2~1_combout\ & (\rx|signal_A_q~q\ & (!\rx|signal_A_q_not~q\ & \rx|state_rx.s1~q\)))
...
\rx|Selector13~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \rx|Selector13~1_combout\ = (\rx|Selector13~0_combout\ & (((!\rx|state_rx~17_combout\) # (!\rx|state_rx~18_combout\)) # (!\rx|state_rx.s3~q\)))
...
PORT MAP (
	...
	datab => \rx|state_rx~18_combout\,
	datac => \rx|state_rx~17_combout\,
	datad => \rx|Selector13~0_combout\,
	combout => \rx|Selector13~1_combout\);
...
\rx|sig_ram_address[5]~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \rx|sig_ram_address[5]~0_combout\ = (\rx|state_rx.s2~q\ & !\rx|sig_data_bit~q\)
...
PORT MAP (
	...
	combout => \rx|sig_ram_address[5]~0_combout\);

-- Location: LCCOMB_X49_Y25_N16
\rx|Selector14~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \rx|Selector14~0_combout\ = (\rx|sig_ram_address[5]~0_combout\) # ((\rx|state_rx.s3~q\ & ((!\rx|state_rx~18_combout\) # (!\rx|state_rx~17_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \rx|sig_ram_address[5]~0_combout\,
	datab => \rx|state_rx~17_combout\,
	datac => \rx|state_rx.s3~q\,
	datad => \rx|state_rx~18_combout\,
	combout => \rx|Selector14~0_combout\);
...
-- Equation(s):
-- \rx|main_rx:var_clk_cntr[5]~0_combout\ = (!\rx|signal_A_q_not~q\ & (\rx|signal_A_q~q\ & ((\rx|state_rx.s3~q\) # (\rx|state_rx.s1~q\))))
...
-- Equation(s):
-- \rx|Add2~1_combout\ = \rx|main_rx:var_clk_cntr[2]~q\ $ (((\rx|main_rx:var_clk_cntr[0]~q\ & \rx|main_rx:var_clk_cntr[1]~q\)))
...
PORT MAP (
	...
	datad => \rx|main_rx:var_clk_cntr[1]~q\,
...
-- Equation(s):
-- \rx|state_rx~18_combout\ = (\rx|state_rx~16_combout\ & ((\rx|main_rx:var_bit_cntr[0]~q\ & (\rx|main_rx:var_bit_cntr[1]~q\ & \rx|Equal3~0_combout\)) # (!\rx|main_rx:var_bit_cntr[0]~q\ & (!\rx|main_rx:var_bit_cntr[1]~q\ & !\rx|Equal3~0_combout\))))
...
-- Equation(s):
-- \rx|Selector15~0_combout\ = (\rx|state_rx~18_combout\ & (\rx|state_rx~17_combout\ & \rx|state_rx.s3~q\))
...
-- Equation(s):
-- \biphase|Selector1~0_combout\ = (\biphase|state_bi.s1~q\) # ((!\biphase|state_bi.s2~q\ & \biphase|sig_read~q\))
...
-- pragma translate_on
PORT MAP (
	datab => \biphase|sig_cut_rd_not~q\,
	datac => \biphase|sig_cut_rd~q\,
...
-- Equation(s):
-- \rx|sig_detected_byte[7]~feeder_combout\ = \rx|sig_data_bit~q\
...
-- Equation(s):
-- \rx|sig_detected_byte[7]~0_combout\ = (\resetn~input_o\ & (\rx|state_rx~16_combout\ & \rx|state_rx.s3~q\))
...
-- pragma translate_on
PORT MAP (
	dataa => \rx|main_rx:var_trns_cntr[12]~q\,
	datad => VCC,
	cin => \rx|Add1~23\,
...
-- Equation(s):
-- \rx|sig_ram_address[0]~1_combout\ = (\rx|Add1~16_combout\ & (!\rx|Add1~18_combout\ & (!\rx|Add1~12_combout\ & !\rx|Add1~14_combout\)))
...
PORT MAP (
	...
	datad => \rx|Add1~14_combout\,
	combout => \rx|sig_ram_address[0]~1_combout\);

-- Location: LCCOMB_X49_Y26_N30
\rx|sig_ram_address[0]~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \rx|sig_ram_address[0]~2_combout\ = (!\rx|Add1~24_combout\ & (!\rx|Add1~20_combout\ & (!\rx|Add1~22_combout\ & \rx|sig_ram_address[0]~1_combout\)))
...
-- pragma translate_on
PORT MAP (
	datab => \rx|main_rx:var_trns_cntr[16]~q\,
	datad => VCC,
	cin => \rx|Add1~31\,
...
-- Equation(s):
-- \rx|sig_ram_address[0]~6_combout\ = (!\rx|Add1~28_combout\ & (\rx|Add1~36_combout\ & (\rx|Add1~26_combout\ & \rx|Add1~30_combout\)))
...
-- Equation(s):
-- \rx|sig_ram_address[0]~5_combout\ = (\rx|Add1~32_combout\ & \rx|Add1~34_combout\)
...
-- Equation(s):
-- \rx|sig_ram_address[0]~3_combout\ = (\rx|sig_bouncer_bit~q\ & (!\rx|Add1~2_combout\ & (!\rx|Add1~0_combout\ & !\rx|state_rx.s0~q\)))
...
-- Equation(s):
-- \rx|sig_ram_address[0]~4_combout\ = (!\rx|Add1~6_combout\ & (\rx|Add1~10_combout\ & (!\rx|Add1~8_combout\ & !\rx|Add1~4_combout\)))
...
-- Equation(s):
-- \rx|sig_ram_address[0]~7_combout\ = (\rx|sig_ram_address[0]~6_combout\ & (\rx|sig_ram_address[0]~5_combout\ & (\rx|sig_ram_address[0]~3_combout\ & \rx|sig_ram_address[0]~4_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \rx|sig_ram_address[0]~6_combout\,
	datab => \rx|sig_ram_address[0]~5_combout\,
	datac => \rx|sig_ram_address[0]~3_combout\,
	datad => \rx|sig_ram_address[0]~4_combout\,
	combout => \rx|sig_ram_address[0]~7_combout\);

-- Location: LCCOMB_X49_Y26_N22
\rx|sig_ram_address[0]~8\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \rx|sig_ram_address[0]~8_combout\ = (\resetn~input_o\ & ((\rx|sig_ram_address[5]~0_combout\) # ((\rx|sig_ram_address[0]~2_combout\ & \rx|sig_ram_address[0]~7_combout\))))
...
PORT MAP (
	...
	datab => \rx|sig_ram_address[0]~7_combout\,
	datac => \resetn~input_o\,
	datad => \rx|sig_ram_address[5]~0_combout\,
...
-- Equation(s):
-- \rx|Selector8~0_combout\ = (\rx|state_rx.s2~q\ & \rx|sig_cnt_address\(2))
...
-- Equation(s):
-- \biphase|sig_toggle~0_combout\ = (!\biphase|sig_read_address_cnt\(0) & (!\biphase|sig_read_address_cnt\(4) & (\biphase|state_mini.s4a~q\ & !\biphase|sig_read_address_cnt\(3))))
...
-- Equation(s):
-- \biphase|sig_read_address[0]~0_combout\ = (\resetn~input_o\ & \biphase|state_mini.s5a~q\)
...
\biphase|sig_read_address[2]~feeder\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \biphase|sig_read_address[2]~feeder_combout\ = \biphase|sig_read_address_cnt\(2)
...
PORT MAP (
	datad => \biphase|sig_read_address_cnt\(2),
	combout => \biphase|sig_read_address[2]~feeder_combout\);
...
PORT MAP (
	clk => \sysclk~inputclkctrl_outclk\,
	d => \biphase|sig_read_address[2]~feeder_combout\,
	ena => \biphase|sig_read_address[0]~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \biphase|sig_shift_data~7_combout\ = (\memory|altsyncram_component|auto_generated|q_b\(0) & \biphase|sig_read~q\)
...
-- pragma translate_on
PORT MAP (
	datab => \memory|altsyncram_component|auto_generated|q_b\(0),
	datad => \biphase|sig_read~q\,
...
-- pragma translate_on
PORT MAP (
	dataa => \biphase|sig_shift_data\(1),
...
-- pragma translate_on
PORT MAP (
	dataa => \memory|altsyncram_component|auto_generated|q_b\(3),
	datac => \biphase|sig_shift_data\(2),
	datad => \biphase|sig_read~q\,
...
PORT MAP (
	...
	datac => \biphase|sig_shift_data\(4),
	datad => \biphase|sig_read~q\,
...
PORT MAP (
	...
	datab => \memory|altsyncram_component|auto_generated|q_b\(6),
	datad => \biphase|sig_read~q\,
...
-- pragma translate_on
PORT MAP (
	dataa => \biphase|sig_shift_data\(6),
...
-- pragma translate_on
PORT MAP (
	dataa => \biphase|sig_shift_data\(7),
	datab => \biphase|sig_cut~q\,
